...
void saveFrame ( void )
{
	...
	KeyFrame[FrameIndex].rotInc=rotInc;
	KeyFrame[FrameIndex].BrIzq = BrIzq;
	KeyFrame[FrameIndex].BrDer= BrDer;
	KeyFrame[FrameIndex].PieDer= PieDer;
	KeyFrame[FrameIndex].PieIzq= PieIzq;
	KeyFrame[FrameIndex].KBZ = KBZ;
	KeyFrame[FrameIndex].cuello = cuello;
	KeyFrame[FrameIndex].cintura = cintura;

	KeyFrame[FrameIndex].rotInc2 = rotInc2;
	KeyFrame[FrameIndex].rotInc3 = rotInc3;
	KeyFrame[FrameIndex].rotInc4 = rotInc4;
	KeyFrame[FrameIndex].rotInc5 = rotInc5;
	KeyFrame[FrameIndex].rotInc6 = rotInc6;
	KeyFrame[FrameIndex].rotInc7 = rotInc7;
	KeyFrame[FrameIndex].rotInc8 = rotInc8;
...
void resetElements( void )
{
	...
	BrDer = KeyFrame[0].BrDer;
	BrIzq = KeyFrame[0].BrDer;
	PieDer = KeyFrame[0].PieDer;
	PieIzq = KeyFrame[0].PieIzq;
	KBZ = KeyFrame[0].KBZ;
	cuello = KeyFrame[0].cuello;
	cintura = KeyFrame[0].cintura; 
...
void interpolation ( void )
{
	...
	KeyFrame[playIndex].rotInc2 = (KeyFrame[playIndex + 1].BrIzq - KeyFrame[playIndex].BrIzq) / i_max_steps;
	KeyFrame[playIndex].rotInc3 = (KeyFrame[playIndex + 1].BrDer - KeyFrame[playIndex].BrDer) / i_max_steps;
	KeyFrame[playIndex].rotInc4 = (KeyFrame[playIndex + 1].PieIzq - KeyFrame[playIndex].PieIzq) / i_max_steps;
	KeyFrame[playIndex].rotInc5 = (KeyFrame[playIndex + 1].PieDer - KeyFrame[playIndex].PieDer) / i_max_steps;
	KeyFrame[playIndex].rotInc6 = (KeyFrame[playIndex + 1].KBZ - KeyFrame[playIndex].KBZ) / i_max_steps;
	KeyFrame[playIndex].rotInc7 = (KeyFrame[playIndex + 1].cuello - KeyFrame[playIndex].cuello) / i_max_steps;
	KeyFrame[playIndex].rotInc8 = (KeyFrame[playIndex + 1].cintura - KeyFrame[playIndex].cintura) / i_max_steps;
...
void monito()
{
	...
	glPushMatrix();//Pecho
		...
		glPushMatrix(); //Brazo izquierdo <--
            ...
            glTranslatef(-1.0, 0.2, 0.2);//DEDO NEGRO
			glColor3f(0, 0, 0);
			fig7.prisma(0.3, 0.5, 0.3, 0);
			...
			glRotatef(BrIzq, 0, 30, 0);      //dedo 2 verde
			...
			glRotatef(BrIzq, 0, 30, 0);      //dedo 2 blanco
			glTranslatef(-0.5, -0.0, 0);
			glColor3f(1, 1, 1);
			fig7.prisma(0.3, 0.5, 0.3, 0);
		...
		glPushMatrix();//Cintura
			...
			glPushMatrix(); //Pie Izquierdo -->
				...
				glPushMatrix();
					glTranslatef(0, -0.5, 0);
					glRotatef(15+rotRodIzq, 1, 0, PieIzq);
					glTranslatef(0, -0.75, 0);
					fig7.prisma(1.5, 0.5, 1, 0);
...
void animacion()
{
	...
	{		
		...
		else
		{
			...
			BrIzq +=KeyFrame[playIndex].BrIzq;
			PieIzq +=KeyFrame[playIndex].rotInc3;
			PieDer +=KeyFrame[playIndex].rotInc4;
			BrDer +=KeyFrame[playIndex].BrDer;
			KBZ += KeyFrame[playIndex].rotInc6;
		    cuello += KeyFrame[playIndex].rotInc7;
			cintura += KeyFrame[playIndex].cintura;
